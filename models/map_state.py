...
class MapState:
    ...
    lamp_cells: list[tuple[int, int]] = field(default_factory=list)
    ...
    car_outer_to_inner: dict[tuple[int, int], tuple[int, int]] = field(default_factory=dict)
    car_inner_to_outer: dict[tuple[int, int], tuple[int, int]] = field(default_factory=dict)
